...
<!-- topbar starts -->
    <div class="navbar navbar-default" role="navigation">
        ...
        <div class="navbar-inner">
            ...
            <a class="navbar-brand" href="index.html"> <img alt="Charisma Logo" src="<%=ctx%>/static/img/logo20.png" class="hidden-xs"/>
            ...
            <div class="sidebar-nav">
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        ...
                        <li><a class="ajax-link" href="mvc/backend/team/teams"><i class="glyphicon glyphicon-home"></i><span> Team</span></a>
                        </li>
